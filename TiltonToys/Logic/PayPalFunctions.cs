...
public class NVPAPICaller
{
    ...
    public string APIUsername = "<cmtilton-facilitator_api1.live.com>";
    private string APIPassword = "<1392250118>";
    private string APISignature = "<AChdN-cwqvdbQCvr2YYtDPfH.doZAssvUxRH1aD3MyPGRlOHSkyuZ2Tw>";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://localhost:<2514>/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:<2514>/Checkout/CheckoutCancel.aspx";
        ...
        using (TiltonToys.Logic.ShoppingCartActions myCartOrders = new TiltonToys.Logic.ShoppingCartActions())
        {
